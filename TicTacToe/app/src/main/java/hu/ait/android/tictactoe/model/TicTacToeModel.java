...
/**
 * Created by jakevitale on 9/21/15.
 */
public class TicTacToeModel {

    //this way of declaring the object and using constructors ensures only one instance of the class
    //is created
    ...
    public void changeNextPlayer() {
        //syntax is same as if-else statement. See below
    ...
    public void isWinner() {
        //Use the model array declared above to check if there is a winner
    }
}